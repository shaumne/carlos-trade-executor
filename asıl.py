    ...
    def calculate_stop_loss(self, symbol, entry_price, swing_low=None):
        ...
        try:
            ...
            if not atr:
                ...
                # Default olarak giriş fiyatının %2 altı
                return round(entry_price * 0.98, 4)
            
            # ATR-tabanlı stop loss
            atr_stop_loss = round(entry_price - (atr * self.atr_multiplier), 4)
            ...
            if swing_low and swing_low < entry_price:
                ...
                final_stop_loss = round(final_stop_loss * 0.99, 4)
            else:
    ...
    def calculate_take_profit(self, symbol, entry_price, resistance_level=None):
        ...
        try:
            ...
            if not atr:
                ...
                # Default olarak giriş fiyatının %3 üstü
                return round(entry_price * 1.03, 4)
            
            # Minimum take profit mesafesi (ATR tabanlı)
            minimum_tp_distance = round(entry_price + (atr * self.atr_multiplier), 4)
            ...
            if resistance_level and resistance_level > minimum_tp_distance:
                final_take_profit = round(resistance_level, 4)
            else:
